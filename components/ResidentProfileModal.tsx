...
import { ResidentData, ComplianceStatus, ReviewHistoryItem } from '../types';
import { X, AlertTriangle, FileText, Activity, Pill, CheckCircle, Clock, AlertCircle, User, Printer, History, LayoutDashboard, RefreshCw, Download } from 'lucide-react';
...
export const ResidentProfileModal: React.FC<Props> = ({ resident, history, onClose }) => {
            ...
            <div className={activeTab === 'overview' ? 'block' : 'hidden print:block break-after-section'}>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 print:grid-cols-1 print:gap-8">
                  <div className="lg:col-span-2 space-y-6">
                      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full print:shadow-none print:border-black print:break-inside-avoid">
                          <div className="bg-slate-50 p-4 border-b border-slate-200 font-bold text-slate-700 flex items-center gap-2 print:bg-gray-100 print:border-black print:text-black"><Pill className="w-4 h-4 text-purple-600 print:text-black"/> Psychotropic Medications</div>
                          <div className="p-0">
                              {resident.meds.length === 0 ? <div className="p-8 text-center text-slate-400 text-sm print:text-black">No active psychotropic medications found.</div> : 
                                  ...
                                  <tbody className="divide-y divide-slate-100 print:divide-black">
                                      {resident.meds.map((med, i) => (
                                          <tr key={i} className="hover:bg-slate-50 print:hover:bg-transparent">
                                              ...
                                              <td className="px-4 py-3 text-slate-600 print:text-black print:px-2">{med.indication || 'Unknown'}</td>
                                              ...
                                              <td className="px-4 py-3 print:px-2"><span className="bg-purple-50 text-purple-700 px-2 py-0.5 rounded text-xs border border-purple-100 print:bg-transparent print:text-black print:border-0 print:p-0 whitespace-nowrap">{med.class}</span></td>
                                          </tr>
                                      ))}
                                  </tbody>
                              </table>}
                      ...
                      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden print:shadow-none print:border-black print:break-inside-avoid">
                          ...
                          <div className="p-4">
                              ...
                              <ul className="space-y-3">
                                  {resident.carePlan.map((item, i) => (<li key={i} className="flex items-start gap-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg print:bg-transparent print:text-black print:border-b print:border-gray-200 print:p-2 print:rounded-none"><CheckCircle className="w-4 h-4 text-green-500 mt-0.5 shrink-0 print:text-black"/>{item.text}</li>))}
                              </ul>}
                          </div>
                      </div>
                  </div>
                      ...
                      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden print:shadow-none print:border-black print:break-inside-avoid">
                          ...
                          <div className="p-0">
                              <div className="max-h-[300px] overflow-y-auto print:max-h-none print:overflow-visible">
                                  {(resident.consults.length === 0 && resident.behaviors.length === 0) ? <div className="p-8 text-center text-slate-400 text-sm print:text-black">No consult or behavior history found.</div> : 
                                  <table className="w-full text-left text-sm">
